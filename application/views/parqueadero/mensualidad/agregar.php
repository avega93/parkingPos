...
<div>
    ...
    <form class="form-horizontal daos_formulario" action="" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input value="<?=$mensualidad['placa_par_mensualidad'] ?>" class="form-control required"  pattern="^[A-Z]{3}[0-9]{2}[A-Z]{1}|^[A-Z]{3}[0-9]{3}|^[A-Z]{3}[0-9]{2}$" style="text-transform:uppercase"  name="placa_par_mensualidad" type="text" id="placa_entrada" placeholder="Inserte placa" maxlength="6" minlength="5">
            </div>
        </div>
        <div class="form-group">
